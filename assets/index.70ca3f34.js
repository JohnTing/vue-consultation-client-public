 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I_ extends Yi{compare(e,n){const r=e.node.compareTo(n.node);return r===0?Wn(e.name,n.name):r}isDefinedOn(e){return!0}indexedValueChanged(e,n){return!e.equals(n)}minPost(){return U.MIN}maxPost(){return U.MAX}makePost(e,n){const r=_e(e);return new U(n,r)}toString(){return".value"}}const C_=new I_;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kx(t){g0(Rr),Sn(new en("database",(e,{instanceIdentifier:n})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),o=e.getProvider("app-check-internal");return vx(r,i,o,n)},"PUBLIC").setMultipleInstances(!0)),Nt(Ll,Fl,t),Nt(Ll,Fl,"esm2017")}mt.prototype.simpleListen=function(t,e){this.sendRequest("q",{p:t},e)};mt.prototype.echo=function(t,e){this.sendRequest("echo",{d:t},e)};kx();let No={};function Mt(t){if(t.length==0)return;speechSynthesis.cancel(),t in No||(No[t]=new SpeechSynthesisUtterance(t));let e=No[t];e.lang="zh-TW",t.length<=1?e.rate=1.6:e.rate=.8,speechSynthesis.speak(e)}var Oa=(t,e)=>{const n=t.__vccOpts||t;for(const[r,i]of e)n[r]=i;return n};const Ma=t=>(Ks("data-v-a8fc8b90"),t=t(),Gs(),t),Ex={class:"container text-center rootbox"},Ix=Ma(()=>D("h3",{class:"h3"},"\u8F38\u5165\u5C31\u8A3A\u5E8F\u865F",-1)),Cx={class:"row g-0 justify-content-center"},Tx={class:"col col-3 box1"},Sx=["onclick"],Rx=Gi(" \xA0\xA0 "),Nx={key:0,class:"alert alert-warning text-center",role:"alert"},Ax=Ma(()=>D("b",{class:"display-2"},"\u8ACB\u8F38\u5165\u5C31\u8A3A\u5E8F\u865F",-1)),Px=[Ax],Ox={key:1,class:"alert alert-warning text-center",role:"alert"},Mx=Ma(()=>D("b",{class:"display-2"},"\u5C31\u8A3A\u5E8F\u865F\u4E0D\u80FD\u8D85\u904E\u4E09\u4F4D\u6578",-1)),Dx=[Mx],Lx=$i({__name:"ButtonGrid",emits:["onNumberChange","onSubmit"],setup(t,{emit:e}){let n="";const r=Oe(!1),i=Oe(!1);function o(l){console.log(l),i.value=n.length>=3,!i.value&&(Mt(""+l),n+=l,e("onNumberChange",n),r.value=n.length==0)}function s(){r.value=n.length==0,r.value||e("onSubmit"),Mt("\u78BA\u8A8D")}function a(){n="",e("onNumberChange",n),i.value=n.length>=3,Mt("\u91CD\u65B0\u8F38\u5165")}return(l,c)=>(le(),me(be,null,[D("div",Ex,[Ix,(le(),me(be,null,mi([[1,2,3],[4,5,6],[7,8,9],[0]],d=>D("div",Cx,[(le(!0),me(be,null,mi(d,u=>(le(),me("div",Tx,[D("button",{class:"btn button1 btn-light",onclick:()=>o(u)},pr(u),9,Sx)]))),256))])),64))]),D("div",{class:"justify-content-center text-center"},[D("button",{class:"btn btn-primary mainbutton",onClick:s},"\u78BA\u8A8D"),Rx,D("button",{class:"btn btn-light mainbutton",onClick:a},"\u91CD\u65B0\u8F38\u5165")]),r.value?(le(),me("div",Nx,Px)):Jt("",!0),i.value?(le(),me("div",Ox,Dx)):Jt("",!0)],64))}});var Fx=Oa(Lx,[["__scopeId","data-v-a8fc8b90"]]);const xm=t=>(Ks("data-v-4faf42d4"),t=t(),Gs(),t),zx={class:"rootbox"},Ux={class:"container text-center",style:{"max-width":"640px"}},Bx=xm(()=>D("h3",null,"\u9078\u64C7\u5C31\u8A3A\u9805\u76EE\uFF0C\u6700\u591A\u9078\u64C7\u5169\u9805",-1)),jx={class:"row"},Wx={class:"col text-center box"},Hx=["id","onClick","disabled","value","name"],$x=["for","value"],Vx={class:"justify-content-center text-center"},qx={key:0,class:"spinner-border spinner-border-sm"},Kx=Gi(" \u78BA\u8A8D"),Gx=Gi(" \xA0\xA0 "),Yx={key:0,class:"alert alert-warning text-center",role:"alert"},Qx=xm(()=>D("b",{class:"display-2"},"\u81F3\u5C11\u9078\u4E00\u500B\u5C31\u8A3A\u985E\u5225",-1)),Jx=[Qx],Xx=$i({__name:"WorkGroup",props:{workgroup:null},emits:["onWorkChange","onSubmit","onClear"],setup(t,{emit:e}){const n=Oe(!1),r=Oe(!1),i=Oe(new Set),o=Oe(!1);function s(c){i.value.has(c)?i.value.delete(c):(Mt(c),i.value.add(c)),r.value=i.value.size>=2,e("onWorkChange",[...i.value])}function a(){n.value=i.value.size<=0,!n.value&&(o.value||(Mt("\u78BA\u8A8D"),e("onSubmit",[...i.value]),o.value=!0))}function l(){i.value.clear(),r.value=!1,e("onWorkChange",[...i.value]),e("onClear"),Mt("\u8FD4\u56DE")}return(c,d)=>(le(),me(be,null,[D("form",{onSubmit:d[0]||(d[0]=u0(()=>{},["prevent"]))},[D("div",zx,[D("div",Ux,[Bx,(le(!0),me(be,null,mi(t.workgroup.values,(u,f)=>(le(),me("div",jx,[(le(!0),me(be,null,mi(u.names,g=>(le(),me("div",Wx,[D("input",{type:"checkbox",class:"btn-check",id:g,onClick:()=>s(g),disabled:r.value&&!i.value.has(g),value:g,name:g},null,8,Hx),D("label",{class:"mylabel",style:Di(`background-color: ${u.color};`),for:g,value:g},pr(g),13,$x)]))),256))]))),256))])])],32),D("div",Vx,[D("button",{class:"btn btn-primary mainbutton",onClick:a,type:"button"},[o.value?(le(),me("span",qx)):Jt("",!0),Kx]),Gx,D("button",{class:"btn btn-light mainbutton",onClick:l,type:"reset"},"\u8FD4\u56DE")]),n.value?(le(),me("div",Yx,Jx)):Jt("",!0)],64))}});var Zx=Oa(Xx,[["__scopeId","data-v-4faf42d4"]]);const Ut=t=>(Ks("data-v-7e60ed10"),t=t(),Gs(),t),ew={class:"container text-center"},tw={class:"rootbox"},nw=Ut(()=>D("br",null,null,-1)),rw=Ut(()=>D("br",null,null,-1)),iw={class:"justify-content-center text-center"},ow=Ut(()=>D("h1",{class:"display-2"},"\u767B\u8A18\u6210\u529F",-1)),sw=Ut(()=>D("br",null,null,-1)),aw=Ut(()=>D("h2",{class:"display-3"},"\u5C31\u8A3A\u9805\u76EE\uFF1A",-1)),lw={class:"display-4 box3"},cw=Ut(()=>D("br",null,null,-1)),dw=Ut(()=>D("h2",{class:"display-3"},"\u767B\u8A18\u6642\u9593\uFF1A",-1)),uw={class:"display-4 box3"},mw=Ut(()=>D("br",null,null,-1)),fw=$i({__name:"FinishPage",props:{workitem:null},emits:["onSubmit"],setup(t,{emit:e}){Mt("\u767B\u8A18\u6210\u529F");function n(){e("onSubmit"),Mt("\u78BA\u8A8D")}const r=new Date,i=Oe(`${r.getHours()<=12?"\u4E0A\u5348":"\u4E0B\u5348"} ${r.getHours()%12}\u9EDE ${r.getMinutes()}\u5206`);return(o,s)=>(le(),me("div",ew,[D("div",tw,[nw,rw,D("div",iw,[ow,sw,aw,D("h3",lw,pr(t.workitem.work+(t.workitem.work2?" + "+t.workitem.work2:"")),1),cw,dw,D("h3",uw,pr(i.value),1),mw])]),D("button",{class:"btn btn-primary mainbutton",onClick:n},"\u78BA\u8A8D")]))}});var pw=Oa(fw,[["__scopeId","data-v-7e60ed10"]]);const hw=D("header",null,null,-1),gw={style:{"touch-action":"none"}},bw=D("br",null,null,-1),_w={class:"row g-0 justify-content-center"},vw=D("br",null,null,-1),xw={class:"col justify-content-center text-center"},ww={class:"display-1 box0"},yw={key:0},kw={key:1},Ew={key:2},Iw=$i({__name:"App",setup(t){let e="";const n=Oe({});ad().onAuthStateChanged(x=>{x&&(e=x.uid,gx(bc(_c(),`users/${e}/workgroup`),C=>{let T=C.val();console.log(T.values);for(const M of T.values)M.color=M.color.replace("_","#");if(n.value=T,!C.exists())return console.error("data not exist.")},{onlyOnce:!0}))});const r=Oe("");Oe((new Date().getHours()<=12?"\u4E0A\u5348\u8A3A":"\u4E0B\u5348\u8A3A")+" XXX \u91AB\u5E2B");const i=Oe({});function o(x){r.value=x}const s=Oe(0),a=Oe([]);function l(){s.value=1}function c(x){console.log(x),a.value=x}function d(){s.value=0,r.value=""}function u(){f().then(()=>{s.value=2})}function f(){let x=Math.floor(new Date().getTime()/1e3);return i.value={patientSerial:parseInt(r.value),work:a.value[0]?a.value[0]:"",work2:a.value[1]?a.value[1]:"",startTime:x,finishTime:-1},console.log(i.value),px(bc(_c(),`users/${e}/worklist/${x}`),{...i.value})}function g(){r.value="",s.value=0,i.value={},a.value=[]}return(x,C)=>(le(),me(be,null,[hw,D("main",gw,[bw,D("div",_w,[vw,D("div",xw,[D("h1",ww,[D("b",null,"\u5C31\u8A3A\u5E8F\u865F: "+pr(r.value),1)])])]),s.value==0?(le(),me("div",yw,[ze(Fx,{onOnNumberChange:o,onOnSubmit:l})])):Jt("",!0),s.value==1?(le(),me("div",kw,[ze(Zx,{workgroup:n.value,onOnWorkChange:c,onOnClear:d,onOnSubmit:u},null,8,["workgroup"])])):Jt("",!0),s.value==2?(le(),me("div",Ew,[ze(pw,{workitem:i.value,onOnSubmit:g},null,8,["workitem"])])):Jt("",!0)])],64))}});var Cw="firebase",Tw="9.8.4";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Nt(Cw,Tw,"app");const Sw={apiKey:"AIzaSyADZGGzgFgmEMTMPsZIamb_jYfOONqNeps",authDomain:"consultation-82f6f.firebaseapp.com",databaseURL:"https://consultation-82f6f-default-rtdb.firebaseio.com",projectId:"consultation-82f6f",storageBucket:"consultation-82f6f.appspot.com",messagingSenderId:"872033401709",appId:"1:872033401709:web:800482f5c58e4bc2963864",measurementId:"G-9WMHKM671T"};function Rw(){zf(Sw);const t=ad();Rp(t,"hscdev@gmail.com","hscdev").then(e=>{const n=e.user;console.log(n.email)}).catch(e=>{const n=e.code,r=e.message;console.log(n),console.log(r)})}Rw();p0(Iw).mount("#app");
